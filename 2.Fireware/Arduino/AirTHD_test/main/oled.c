...
void oled_claer_2(void)
{
    //清0缓存
    memset(g_oled_buffer+sizeof(g_oled_buffer)/4,SSD1306_COLOR_BLACK,sizeof(g_oled_buffer)/4-128);
    oled_update_screen();
}

void oled_claer_4(void)
{
    //清0缓存
    memset(g_oled_buffer+sizeof(g_oled_buffer)*3/4 - 128,SSD1306_COLOR_BLACK,sizeof(g_oled_buffer)/4+128);
    oled_update_screen();
}
/** 
 * 填屏
