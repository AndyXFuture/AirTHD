...
#define ESP_UUID    {0xFD, 0xA5, 0x06, 0x93, 0xA4, 0xE2, 0x4F, 0xB1, 0xAF, 0xCF, 0xC6, 0xEB, 0x07, 0x64, 0x78, 0x33}
//#define ESP_MAJOR 65535
//#define ESP_MINOR 65535
uint16_t ESP_MAJOR;
uint16_t ESP_MINOR;
...
uint16_t ENDIAN_CHANGE_U16(uint16_t x);